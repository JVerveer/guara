...
create index if not exists fact_housing_observation_dataset_measure_year_observation_idx
  on gold_bouwen_wonen.fact_housing_observation(dataset_code, measure_key, calendar_year, housing_observation_key)
  where observation_value is not null and is_missing = false and calendar_year is not null;
